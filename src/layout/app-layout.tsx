...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Coach', path: '/coaches', entity: 'coach', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
  { name: 'Parent', path: '/parents', entity: 'parent', service: AccessServiceEnum.PROJECT, icon: FiUsers },
  { name: 'Player', path: '/players', entity: 'player', service: AccessServiceEnum.PROJECT, icon: FiPlayCircle },
  {
    name: 'Player Profile',
